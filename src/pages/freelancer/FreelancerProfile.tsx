    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_BASE_URL}/freelancer/getUserDt`,
          {
            headers: {
    ...
    <>
      ...
      >
        ...
        {loading ? (
          ...
          <FreelancerProfileActiveGigs activeGigs={activeGigs} />
        ) : (
          <FreelancerProfilePendingGigs pendingGigs={pendingGigs} />
        )}
      </Container>
